...
public class Renderer {
	...
	public void render(EntityS entity, StaticShader shader)
	{
	...
	public void render2(EntityS entity, StaticShader shader)
	{
		RawModel model = entity.getModel();
		GL30.glBindVertexArray(model.getVaoId());
		GL20.glEnableVertexAttribArray(0);
	...
	public Matrix4f getProjMatr() {return new Matrix4f(_projMatr);}
	...
	{
		for (EntityS ent : axes.getEntities())
		{
			render2(ent, shader);
		}
	}
