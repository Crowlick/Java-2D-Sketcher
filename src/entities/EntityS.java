...
public class EntityS implements Renderable
{
	...
	public EntityS(RawModel model, Vector3f pos, Vector3f rot, Vector3f scale)
	{
		_model = model;
	...
	public EntityS(Vector3f pos, Vector3f rot, Vector3f scale)
	{
		_pos = new Vector3f(pos);
		_rot = new Vector3f(rot);
		_scale = new Vector3f(scale);
	...
	public EntityS(Vector3f pos, Vector3f rot, float scale)
	{
		_pos = new Vector3f(pos);
		_rot = new Vector3f(rot);
	...
	public EntityS(Vector3f pos) {_pos = new Vector3f(pos);}
	
	public void setModel(RawModel model) {_model = model;}
	
	public EntityS(RawModel model)
	{
		_model = model;
	}
	
	public EntityS(RawModel model, Vector3f pos, Vector3f rot, float scale)
	{
		_model = model;
		_pos = new Vector3f(pos);
		_rot = new Vector3f(rot);
